...
"""
生成测试账号和随机健康数据
此脚本用于创建5个测试用户账号，并为每个账号生成随机的健康数据
使用方法: python manage.py runscript generate_test_accounts
"""
...
from models import UserProfile, WearableData
...
class TestAccountGenerator:
    ...
    def save_health_data(self, health_data):
        ...
        try:
            if health_data:
                result = wearable_data_collection.insert_many(health_data)
